...
df1 = dataframe[dataframe['ENTITY_NAME'] == 'Skyguide']

field = 'CPLX_INTER'
df1 = apply_moving_average(df1, window_size=30, perc=30, component = field)
...
print(f'Score: {(score/len(test.values))**0.5}')
